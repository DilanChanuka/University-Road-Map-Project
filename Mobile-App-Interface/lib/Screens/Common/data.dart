...
List<String> ground_floor=[  "CS Wash Rooms","CS Computer Lab 01","CS Car park"];
...
List<String> first_floor=[ "CS Record Room", "CS Special Lab","CS Lecture's Room",
  ...
  "CS E-Learning Center","CS Conference Room","CS Head's Room","CS Computer lab 02","CS Record Room"];
